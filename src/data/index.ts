...
export const productList: IProduct[] = [
  {
    ...
    description:
      "Versatile Canon camera with sharp image quality, Full HD video, built-in Wi-Fi, and easy-to-use features.",
    imageURL:
  ...
  {
    id: uuid(),
    title: "ATX Mid Tower PC Case",
    description:
      "As luxury T-Shirt is just as distinctive and can be trimmed with premium materials like Nappa leather and carbon fiber.",
    imageURL:
      "https://images.unsplash.com/photo-1591238372338-22d30c883a86?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    price: "1500",
    colors: [],
    category: {
      name: "PC Desktop",
  ...
  // 5
  {
    ...
    description:
      "Elegant and cozy chair with soft upholstery, sturdy frame, and a modern look perfect for any room or workspace.",
    imageURL:
  ...
  },
  {
    ...
    description:
      "Comfortable and breathable cotton tee with a timeless fit, perfect for daily wear and easy to match with any outfit.",
    imageURL:
  ...
  },
  {
    ...
    description:
      "Reliable desktop PC with fast performance, ideal for work, gaming, or daily use with smooth multitasking and storage.",
    imageURL:
      "https://images.unsplash.com/photo-1552831388-6a0b3575b32a?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1632&q=80",
    price: "1500",
    colors: [],
